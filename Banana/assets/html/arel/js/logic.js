// Created by Metaio_Creator_6.0_MACOS_DEMO_MODE_2014-10-28T12:03:21
...
arel.sceneReady(function() {
    ...
    scenario.currentTrackingConfigPathOrIdentifier = "html/resources/TrackingConfig_fd3f98643b2c8c98f56d5c6036b69f62.zip";
    ...
    scenario.onStartup = function () {
        arel.Debug.log("Welcome to the 'Test2' Augmented Reality experience.");
    ...
    // fruits60
    if (!arel.Scene.objectExists("image6")) {
        arel.Debug.log("ERROR: retrieving the object image6, it seems that it does not exist. Maybe it would help cleaning the cache or a problem occurred while reloading the channel.");
    }
    ...
    image6.type = "Image";
    image6.scene = scene1;
    image6.associatedTrackable = pattern3;
    ...
    image6.play = function (animationName, animationLooped) {
